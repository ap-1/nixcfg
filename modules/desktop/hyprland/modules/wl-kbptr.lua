...
hl.bind("SUPER + SHIFT + semicolon", hl.dsp.exec_cmd("pkill wl-kbptr || wl-kbptr -o modes=tile,split"))
...
hl.define_submap("cursor", function()
	...
	hl.bind("A", hl.dsp.exec_cmd("pkill wl-kbptr || wl-kbptr -o modes=floating,click -o mode_floating.source=detect"))
